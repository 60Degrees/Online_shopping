...
$ret=mysql_query("select productImage2 from products where id='$pid'");
...
//unlink($dir.'/'.$pimage);
	...
	$sql=mysql_query("update  products set productImage2='$productimage2' where id='$pid' ");
...
$query=mysql_query("select productName,productImage2 from products where id='$pid'");
$cnt=1;
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($row['productName']);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> 
</div>
</div>
