...
<h3>Best Deals</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="http://twitter.com"><i class="icon fa fa-twitter"></i></a>
        <a href="http://linkedin.com"><i class="icon fa fa-linkedin"></i></a>
        <a href="http://facebook.com"><i class="icon fa fa-rss"></i></a>
        <a href="http://pintrest.com"><i class="icon fa fa-pinterest"></i></a>
...
<div class="contact-timing">
	<div class="module-heading">
		<h4 class="module-title">Contact timings</h4>
	</div><!-- /.module-heading -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">bestdeals_contact@gmail.com</a></span><br>
					<span><a href="#">aneesh810@gmail.com</a></span>
                </div>
            </li>
